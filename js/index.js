...
searchBarValue.addEventListener("keyup", (e) => {
  ...
  API_SEARCH_URL = "https://www.themealdb.com/api/json/v1/1/search.php?s=";
  let searchValueInput = document.getElementById("search-value").value;
  API_SEARCH_URL += searchValueInput;
  populateSearchList(API_SEARCH_URL);
